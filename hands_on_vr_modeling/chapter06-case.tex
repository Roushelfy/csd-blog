...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{img/complete_3.pdf}
    ...
    % More examples are available on an online \href{https://anonymous.4open.science/w/VR-doh-85B8/}{3D viewer}.
    }}
...
%
Subsequently, wooden frames were interlocked and freely stacked into an arch through gravity and contact interactions, then merged seamlessly with greenery. The greenery’s complex shapes were also easily refined by hand. 
...
Finally, a capybara plush toy was made to appear fatter, while its head decoration was reshaped into a strawberry and placed in the front. These examples highlight VR-Doh’s ability to simplify complex modeling tasks while maintaining creativity and controllability. 
% All examples are available on an online \href{https://anonymous.4open.science/w/VR-doh-85B8/}{3D viewer}.
\begin{figure*}[htbp]
    \centering
        \includegraphics[width=0.8\linewidth]{img/Gaussian_Examples.jpg}
        
    \captionof{figure}{\textbf{3D GS object editing examples.} Users combined, reshaped, and customized models using hand gestures and tools, bringing objects to life, merging elements seamlessly, and refining intricate details with ease. These examples highlight VR-Doh’s ability to simplify complex modeling tasks while preserving creativity and control. 
    % More examples are available on an online \href{https://anonymous.4open.science/w/VR-doh-85B8/}{3D viewer}.
    }
